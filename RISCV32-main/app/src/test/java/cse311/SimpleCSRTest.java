...
public class SimpleCSRTest {
    ...
    public void testBasicCSRAccess() {
        ...
        System.out.println("Initial MSTATUS: 0x" + Integer.toHexString(cpu.readCSRTest(RV32iCpu.MSTATUS)));
        
        // Write a value directly
        cpu.writeCSRTest(RV32iCpu.MSTATUS, 0x1234);
        System.out.println("After direct write MSTATUS: 0x" + Integer.toHexString(cpu.readCSRTest(RV32iCpu.MSTATUS)));
        
        assertEquals(0x1234, cpu.readCSRTest(RV32iCpu.MSTATUS), "Direct CSR write/read failed");
    }
    ...
    public void testCSRRWInstruction() {
        ...
        System.out.println("  MSTATUS: 0x" + Integer.toHexString(cpu.readCSRTest(RV32iCpu.MSTATUS)));
        ...
        assertEquals(0x5678, cpu.readCSRTest(RV32iCpu.MSTATUS), "CSRRW should write x2 value to MSTATUS");
    }
}