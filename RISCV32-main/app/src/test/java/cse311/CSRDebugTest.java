...
public class CSRDebugTest {
    ...
    public void debugCSRSI() {
        ...
        cpu.writeCSRTest(RV32iCpu.MSTATUS, 10);
        System.out.println("Initial MSTATUS: " + cpu.readCSRTest(RV32iCpu.MSTATUS));
        ...
        System.out.println("  MSTATUS: " + cpu.readCSRTest(RV32iCpu.MSTATUS));
        System.out.println("  x2: " + cpu.getRegister(2));
        
        cpu.executeTest(inst);
        
        System.out.println("After CSRRSI:");
        System.out.println("  MSTATUS: " + cpu.readCSRTest(RV32iCpu.MSTATUS) + " (should be " + (10 | 8) + ")");
        ...
        assertEquals(10, cpu.readCSRTest(RV32iCpu.MSTATUS), "MSTATUS should be 10 | 8 = 10");
    }
}